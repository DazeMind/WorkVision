...
<template>
    <AuthenticatedLayout title="Dashboard">
      <!-- <Alert v-if="totalExpenses > gastoMaximoRecomendado">
        ¡Atención! Estás gastando más de lo recomendado este mes.
      </Alert> -->

      <div>
        <CardsDashBoard :companies="companies" :totalIncome="$page.props.totalIncome" :totalExpenses="$page.props.totalExpenses" />
      </div>
      ...
      <!-- <DashboardTrends :incomeData="..." :expensesData="..." /> -->
      ...
      <Alert v-if="someAlertCondition"> ... </Alert>
      
      <UpcomingCalendar :events="..." /> -->

        <div class="p-6 overflow-hidden mt-5 bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        ...
        <div v-else>
            <p>No tienes una Wallet asociada.</p>
            <p>Para vincular <a href="/wallet">haz clic aquí.</a></p>
        </div>
          </div>
                  <!-- <Button
                    v-if="SuperAdminRole"
            ...
            <div class="mt-5" v-if="companies[0].type == 'orders/sales'">
              <FullCalendar :orders="companies[0].orders" />
            </div>
        </div>
